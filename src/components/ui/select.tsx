  ...
  return (
    <label className="flex w-full flex-col gap-2">
      ...
      <select
        id={id}
        className={cn(
          "h-12 rounded-lg border border-line-solid bg-bg-normal px-4 text-label-normal outline-none transition focus:border-primary focus:ring-4 focus:ring-primary/10",
