...
export function ThemeToggle({ className }: ThemeToggleProps) {
  ...
  return (
    <button
      ...
      className={cn(
        "chrome-surface inline-flex h-9 items-center gap-2 rounded-full border border-line-solid bg-bg-normal/90 px-3 text-label-strong shadow-xs backdrop-blur transition-[background-color,border-color,box-shadow,transform,opacity] duration-500 ease-[cubic-bezier(0.22,1,0.36,1)]",
